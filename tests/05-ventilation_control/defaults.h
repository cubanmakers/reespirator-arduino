...
#define VENTILATION_CONTROL_CYCLE 5 //msec
...
#define MECH_LOWEST_POSITION     (STEPPER_MICROSTEPS *   70)   // Steps
#define MECH_HIGHEST_POSITION    (STEPPER_MICROSTEPS * -120)   // Steps
